...
class ImageSaver:
    def __init__(
            ...
            udp_multicast_ip: str, udp_multicast_port: int, udp_multicast_interface_ip: str, udp_ttl: int,
            press_line: str,
            saved_dir: str,
    ...
    async def create(
        ...
        saver = cls(
            ...
            udp_multicast_ip=udp_multicast_ip, udp_multicast_port=udp_multicast_port, udp_multicast_interface_ip=udp_multicast_interface_ip, udp_ttl=udp_ttl,
    ...
    async def save_images_loop(self):
        while True:
        ...
        _logger.info(f"{self.identity} save_images_loop() ended")
